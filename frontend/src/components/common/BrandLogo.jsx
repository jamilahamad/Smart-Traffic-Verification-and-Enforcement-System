...
const variantConfig = {
    ...
    login: {
        ...
        titleClass: 'text-xl font-black text-white tracking-tight leading-tight',
        subtitleClass: 'text-[11px] font-medium text-blue-100 leading-tight',
    ...
    navbar: {
        ...
        iconSize: 20,
        iconColorClass: 'text-white',
        textWrapperClass: 'hidden sm:flex flex-col items-start text-left leading-none',
        titleClass: 'block text-lg font-bold text-gray-800 leading-tight',
        subtitleClass: 'block text-[10px] text-gray-400 leading-tight mt-0.5 whitespace-nowrap',
        subtitle: 'Smart Traffic Verification',
    },
